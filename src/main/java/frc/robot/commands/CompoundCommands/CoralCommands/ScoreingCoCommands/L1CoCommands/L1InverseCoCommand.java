...
public class L1InverseCoCommand extends SequentialCommandGroup{



    public L1InverseCoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed) {
